...
/* ============================================================
 * Payload unificado por aba (Alinhado com o faturamento real)
 * ============================================================ */
...
const TAB_META = {
  produtividade: { label: '⏱️ Produtividade & Horas' },
  cobertura: { label: '🏥 Cobertura por Setor' },
  financeiro: { label: '💰 Repasse Financeiro' },
  auditoria: { label: '🛡️ Log de Auditoria' },
};

/* ============================================================
 * Modal de Pré-Visualização Oficial
 * ============================================================ */
...
export default function Relatorios() {
  ...
  // Motor unificado e blindado de faturamento real por profissional
